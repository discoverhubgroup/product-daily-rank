...
|------------|------------|---------------|---------------- |
| 1 |  [cathrynlavery/diagram-design](https://github.com/cathrynlavery/diagram-design)| 18.4k  | 🔺1426 |
| 2 |  [guillaumemeyer/watermarks-remover](https://github.com/guillaumemeyer/watermarks-remover)| 9.6k  | 🔺1841 |
| 3 |  [semantica-agi/semantica](https://github.com/semantica-agi/semantica)| 7.9k  | 🔺431 |
| 4 |  [holaboss-ai/holaOS](https://github.com/holaboss-ai/holaOS)| 7.6k  | 🔺407 |
| 5 |  [cactus-compute/needle](https://github.com/cactus-compute/needle)| 6k  | 🔺482 |
| 6 |  [lightningpixel/modly](https://github.com/lightningpixel/modly)| 6.1k  | 🔺252 |
| 7 |  [PrimeIntellect-ai/prime-agent](https://github.com/PrimeIntellect-ai/prime-agent)| 16.2k  | 🔺350 |
| 8 |  [tt-a1i/archify](https://github.com/tt-a1i/archify)| 12.9k  | 🔺460 |
| 9 |  [macro-inc/macro](https://github.com/macro-inc/macro)| 3.2k  | 🔺282 |
| 10 |  [firecrawl/anydoc](https://github.com/firecrawl/anydoc)| 16.3k  | 🔺190 |
...
- **开源时间**：2026-04-17
## 2.AI 水印溯源标记清除工具:watermarks-remover 9.6k⭐
...
- **主要语言**：[Python](https://github.com/search?q=language:Python&type=repositories)
- **开源时间**：2026-02-24
## 6.本地 GPU3D 模型生成软件:modly 6.1k⭐
![](https://discoverhub.cn/image/product/20260816/3aa32f53-cd20-4709-984e-342ff02ec318.png)
- **产品地址**：[https://modly3d.app](https://discoverhub.cn/product/detail/01M01BFVC4NFKATV877EA0KPR8)
- **产品介绍**：桌面端应用，依靠本地 GPU 算力，通过图片或者文本提示词直接生成 3D 模型，数据无需上传云端。
- **产品分类**：[[3D与动画](https://discoverhub.cn/category/01KH0X3V85R862ZG3WKA17ZZRW)] [[3D可视化](https://discoverhub.cn/category/01H0KWHGGH58YK7JT06AY000TW)] [[macOS](https://discoverhub.cn/category/01KH3FGD50VE04AS6A3QCC405S)] 
...
- **Github数据**：star:**6.1k** watch:**46** fork:**611** pr:**179** issue:**83** release:**12**
- **近期趋势**： 周增长: **764**⭐	 月增长: **764**⭐
- **主要语言**：[TypeScript](https://github.com/search?q=language:TypeScript&type=repositories)
- **开源时间**：2026-03-18
## 7.自迭代 RLM 智能体:prime-agent 16.2k⭐
...
- **开源时间**：2026-04-15
## 9.团队统一协作工作平台:macro 3.2k⭐
![](https://discoverhub.cn/image/product/20260816/da7933d8-cdcd-4fd5-9091-7e8d050fa14e.png)
- **产品地址**：[https://macro.com](https://discoverhub.cn/product/detail/01KZYNN8E7CMV2KMTD1M5T007J)
- **产品介绍**：面向团队的统一协作空间，整合邮件、文档、任务、通话、CRM，依托共享 AI 记忆实现内容相互关联调用。
- **产品分类**：[[办公协作](https://discoverhub.cn/category/01KH0YHWPR7WS5JRHFSKSRNG2N)] [[企业服务](https://discoverhub.cn/category/01KPGC95D67V0DBPGRV2KHS000)] [[工作流](https://discoverhub.cn/category/01KH3HZE1SE3TWDV56F7WH47J2)] 
- **产品外站**：[[github](https://github.com/macro-inc/macro)] 
- **Github地址**：[https://github.com/macro-inc/macro](https://github.com/macro-inc/macro)
- **Github数据**：star:**3.2k** watch:**44** fork:**320** pr:**5.6k** issue:**33** release:**195**
- **近期趋势**： 周增长: **1.6k**⭐	 月增长: **1.6k**⭐
- **主要语言**：[Rust](https://github.com/search?q=language:Rust&type=repositories)
- **开源时间**：2025-11-08
## 10.多格式文档转Markdown工具:anydoc 16.3k⭐
